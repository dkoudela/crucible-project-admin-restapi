 ...
 */
@JsonAutoDetect
public class ResponseRepositoryNameList {
	@JsonProperty
	Map<String, String> response;
	@JsonProperty
	Set<String> repositoryNames;

	public ResponseRepositoryNameList() {
		this.response = new LinkedHashMap<String, String>();
		this.repositoryNames = new LinkedHashSet<String>();
	}

	public ResponseRepositoryNameList(Map<String, String> response, Set<String> repositoryNames) {
