 ...
 */
@JsonAutoDetect
public class ResponseRepositoryDataImpl implements ResponseRepositoryData {
	@JsonProperty
	Map<String, String> response;
	@JsonProperty
	RepositoryRestData repositoryRestData;

	public ResponseRepositoryDataImpl(Map<String, String> response, RepositoryRestData repositoryRestData) {
		this.response = response;
		this.repositoryRestData = repositoryRestData;
	}

	public ResponseRepositoryDataImpl() {
