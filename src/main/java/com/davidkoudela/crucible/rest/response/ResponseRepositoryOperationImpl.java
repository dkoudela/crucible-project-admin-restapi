 ...
 */
@JsonAutoDetect
public class ResponseRepositoryOperationImpl implements ResponseRepositoryOperation {
	@JsonProperty
	 ...
	 */
	public ResponseRepositoryOperationImpl()
	{
		this.response = new LinkedHashMap<String, String>();
	}

	public ResponseRepositoryOperationImpl(Map<String, String> response)
	{
